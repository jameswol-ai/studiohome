...
def render():
    ...
    if st.button("🏗️ Generate & Sync Massing Envelopes", use_container_width=True):
        massing_list = []
        total_gfa_gen = 0
        ...
        # Sync back to global master project state
        ...
        fig = px.bar(df_mass, x="Block ID", y="Height (m)", color="Primary Program", title="Synchronized Volumetric Height Distribution", template="plotly_dark", height=320)
