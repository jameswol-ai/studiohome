...
def render():
    ...
    fig = px.bar(mep_df, x="System Domain", y="Consumption Share (%)", color="System Domain", title="Annual Energy Balance & Load Distribution", template="plotly_white", height=320)
